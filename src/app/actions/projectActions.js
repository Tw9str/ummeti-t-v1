...
import { generateUniqueSlug, getLocalizedField } from '@/lib/utils';
...
export async function addProjectAction(prevState, formData) {
  ...
  const category = formData.get('category')
    ? JSON.parse(formData.get('category'))
    : getLocalizedField(formData, 'category');

  const formObject = {
    title: getLocalizedField(formData, 'title'),
    description: getLocalizedField(formData, 'description'),
    category,
